var gifter = ['Marianne', 'Sarah', 'Lochlan', 'Pedro', 'Nigel', 'Lizbeth', 'Chaz', 'Lynna', 'Catherine', 'Nada', 'Madison', 'Chrystopher', 'Wyatt', 'Carlos', 'Taisei', 'Eddie', 'JD', 'Rhea'];
...
var food = ["No", "no", "No :)", "None!", "Honey", "peanuts/treenuts", "Vegan", "No", "No", "No.", "Halal but vegetarian is ok!", "No. ", "Vegang (I'm vegan by the way)", "I'm mainly Vegetarian but will eat Chicken. ", "No", "No!", "No", "No"];
